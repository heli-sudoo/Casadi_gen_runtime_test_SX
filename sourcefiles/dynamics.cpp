...
{   
    ...
    {
        Forward_dyn_old(x,u,x_next,y);
        // Forward_dyn(x,u,x_next,y);
        Forward_dyn_par_old(x, u, fx,fu, gx,gu);
...
void Initialization()
{
    ...
    Mat = {&fx, &fu, &gx, &gu};
    Initialize_Mat(Dyn_FL_par_sparsity_out, Mat);
}
...
void Forward_dyn_old(StateVec &x, ContrlVec &u, StateVec &x_next, OutputVec &y)
{
    double **arg;
    double **res,  *w;
    int_T *iw;
...
void Forward_dyn_par_old(StateVec &x, ContrlVec &u, SpMat&fx, SpMat&fu, SpMat&gx, SpMat&gu)
{
    double **arg, **res, *w;
    int_T *iw;
    size_t n_in, n_out, ou;  
